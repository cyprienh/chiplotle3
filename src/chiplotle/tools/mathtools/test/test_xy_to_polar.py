...
def test_xy_to_polar_03( ):
   ...
   assert r == 1
   assert round(a, 6) == round(old_div(math.pi, 2), 6)
...
def test_xy_to_polar_05( ):
   ...
   r, a = mathtools.xy_to_polar((0, -1))
   assert r == 1
   assert round(a, 6) == round(old_div(math.pi, 2) * 3, 6)
...
def test_xy_to_polar_06( ):
   ...
   assert round(a, 6) == round(old_div(math.pi, 4), 6)
...
def test_xy_to_polar_07( ):
   ...
   r, a = mathtools.xy_to_polar((-1, 1))
   assert round(r, 6) == round(math.sqrt(2), 6)
   assert round(a, 6) == round(old_div(math.pi, 4) * 3, 6)
...
def test_xy_to_polar_08( ):
   ...
   r, a = mathtools.xy_to_polar((-1, -1))
   assert round(r, 6) == round(math.sqrt(2), 6)
   assert round(a, 6) == round(old_div(math.pi, 4) * 5, 6)
...
def test_xy_to_polar_09( ):
   ...
   r, a = mathtools.xy_to_polar((1, -1))
   assert round(r, 6) == round(math.sqrt(2), 6)
   assert round(a, 6) == round(old_div(math.pi, 4) * 7, 6)
