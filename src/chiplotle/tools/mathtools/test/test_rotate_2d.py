...
def test_rotate_2d_05( ):
   ...
   xy = (1, 0)
   t = mathtools.rotate_2d(xy, old_div(math.pi, 2))
   assert round(t[0], 6) == 0
   assert round(t[1], 6) == 1
   t = mathtools.rotate_2d(xy, old_div(math.pi, 4))
...
def test_rotate_2d_pivot_02( ):
   '''Rotate 2d can rotate around an arbitrary pivot point.'''
   xy = (1, 0)
   t = mathtools.rotate_2d(xy, old_div(math.pi, 2), (1, 1))
   assert round(t[0], 6) == 2
   assert round(t[1], 6) == 1
   t = mathtools.rotate_2d(xy, old_div(math.pi, 4), (1, 1))
