...
def test_polar_to_xy_06( ):
   t = mathtools.polar_to_xy(Coordinate(1, old_div(math.pi, 2)))
...
def test_polar_to_xy_08( ):
   t = mathtools.polar_to_xy(Coordinate(1, old_div(math.pi, 2) * 3))
   assert round(t[0], 6) == 0
   assert round(t[1], 6) == -1


def test_polar_to_xy_09( ):
   t = mathtools.polar_to_xy(Coordinate(1, old_div(math.pi, 2) * 4))
   assert round(t[0], 6) == 1
   assert round(t[1], 6) == 0
...
def test_polar_to_xy_10( ):
   t = mathtools.polar_to_xy(Coordinate(1, old_div(math.pi, 4) * 1))
   assert round(t[0], 6) == round(old_div(math.sqrt(2), 2), 6)
   assert round(t[1], 6) == round(old_div(math.sqrt(2), 2), 6)


def test_polar_to_xy_11( ):
   t = mathtools.polar_to_xy(Coordinate(1, old_div(math.pi, 4) * 3))
   assert round(t[0], 6) == round(old_div(-math.sqrt(2), 2), 6)
   assert round(t[1], 6) == round(old_div(math.sqrt(2), 2), 6)


def test_polar_to_xy_12( ):
   t = mathtools.polar_to_xy(Coordinate(1, old_div(math.pi, 4) * 5))
   assert round(t[0], 6) == round(old_div(-math.sqrt(2), 2), 6)
   assert round(t[1], 6) == round(old_div(-math.sqrt(2), 2), 6)


def test_polar_to_xy_13( ):
   t = mathtools.polar_to_xy(Coordinate(1, old_div(math.pi, 4) * 7))
   assert round(t[0], 6) == round(old_div(math.sqrt(2), 2), 6)
   assert round(t[1], 6) == round(old_div(-math.sqrt(2), 2), 6)
